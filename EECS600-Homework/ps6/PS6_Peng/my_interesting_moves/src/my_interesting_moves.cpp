...
void My_interesting_moves::set_goal_wave(trajectory_msgs::JointTrajectory &des_trajectory) {
    int g_count = 0;
    Vectorq7x1 q_pre_pose;
    Eigen::VectorXd q_in_vecxd;
    Vectorq7x1 q_vec_right_arm;
...
void My_interesting_moves::set_goal_sayhi(trajectory_msgs::JointTrajectory &des_trajectory) {
    int g_count = 0;
    Vectorq7x1 q_pre_pose;
    // q_in << 0, 0, 0, 0, 0, 0, 0;
