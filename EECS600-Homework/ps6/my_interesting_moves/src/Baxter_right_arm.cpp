...
Baxter_right_arm::Baxter_right_arm(ros::NodeHandle* nodehandle){
...
void Baxter_right_arm::initializeSubscribers()
{
    ROS_INFO("Initializing Subscribers");
    joint_state_sub_ = nh_.subscribe("robot/joint_states", 1, &Baxter_right_arm::jointStatesCb,this);  
    // add more subscribers here, as needed
}

//member helper function to set up publishers;
void Baxter_right_arm::initializePublishers()
{
...
double Baxter_right_arm::transition_time(Vectorq7x1 dqvec) {
...
double Baxter_right_arm::transition_time(Eigen::VectorXd dqvec) {
    double t_max = fabs(dqvec[0])/qdot_max_vec[0];
    cout<<"qdot max: "<<qdot_max_vec.transpose()<<endl;
    double ti;
    for (int i=1;i<7;i++) {
...
void Baxter_right_arm::stuff_trajectory( std::vector<Eigen::VectorXd> qvecs, trajectory_msgs::JointTrajectory &new_trajectory) {
    //new_trajectory.clear();
    trajectory_msgs::JointTrajectoryPoint trajectory_point1;
    //trajectory_msgs::JointTrajectoryPoint trajectory_point2; 
...
void Baxter_right_arm::pub_right_arm_trajectory(trajectory_msgs::JointTrajectory &new_trajectory) {
...
void Baxter_right_arm::pub_right_arm_trajectory_init() {
